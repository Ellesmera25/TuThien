    ...
    return (
        <form onSubmit={handleSubmit} className="grid gap-6">
            <section className="grid gap-4">
                ...
                <div className="rounded-xl border border-primary-fixed bg-primary-fixed/20 p-4 text-sm leading-6 text-on-surface-variant">
                    Tài khoản nhận giải ngân được lấy từ hồ sơ đơn vị đồng hành đã được
                    admin duyệt. Bạn không cần nhập lại khi đăng ký đồng hành hoặc yêu cầu
                    giải ngân.
                </div>
