                                                ...
                                                return (
                                                    <div className="mt-4 flex flex-wrap items-center gap-6 rounded-xl border border-white/70 bg-white/70 p-4">
                                                        ...
                                                        <img
                                                            ...
                                                            className="h-60 w-48 rounded-lg border border-outline-variant/50 bg-white p-2 shadow-sm"
                                                        />
...
function getSupportCampaignOptions(offers: SupportOfferRow[]) {
    ...
    for (const offer of offers) {
        if (!campaignById.has(offer.campaign_id)) {
            campaignById.set(
                offer.campaign_id,
                offer.campaign?.title ?? "Dự án không xác định",
            );
        }
    }
