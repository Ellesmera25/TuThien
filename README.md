...
- Mau chinh: navy `#0b1f3a` tren nen trang/slate sang; nut noi dung chinh dung xanh duong sang don sac, header/nav tren van giu navy/luc bao de tao cam giac minh bach, dang tin cay.
...
- Global utility classes: `neo-panel`, `neo-panel-strong`, `neo-badge`, `neo-btn`, `surface-card`, `soft-band`. `neo-btn-primary` dung xanh duong sang don sac cho nut noi dung; `neo-btn-nav-primary` giu gradient navy/luc bao rieng cho nut action trong header de navi tren khong bi doi style.
