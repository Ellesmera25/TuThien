...
- Global utility classes: `neo-panel`, `neo-panel-strong`, `neo-badge`, `neo-btn`, `surface-card`, `soft-band`. `neo-btn-primary` dung gradient trang-xanh la cho nut noi dung; `neo-btn-nav-primary` giu gradient navy/luc bao rieng cho nut action trong header de navi khong bi doi style.
